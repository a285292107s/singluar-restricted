...
--- 只支持组件包
---@type fun(typeName:string):nil
_assets_selection = function(typeName) end

--- 只支持ttf
---@type fun(ttfName:string):nil
_assets_font = function(ttfName) end

--- 只支持tga
---@type fun(tga:string):nil
...
--- 原生首符号加:冒号
--- 只支持tga
---@type fun(path:string, alias:string|nil):nil
...
---@type fun(path:string, alias:string|nil, class:string|nil|"'unit'"|"'item'"|"'destructable'", options:noteAssetsModelUnitOptions|noteAssetsModelItemOptions|noteAssetsModelDestOptions):nil
...
--- 音效荐：48000HZ 192K 单
--- 音乐荐：48000HZ 320K 单
---@type fun(path:string, alias:string|nil, soundType:string | "vcm"| "v3d" | "bgm" | "vwp"):nil
