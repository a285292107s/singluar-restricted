...
---@desc 特性6、同一Rect，只添加最多1种天气时，此天气添加[迷雾类型|光束类型]后，可后续修改为其他[迷雾类型|光束类型](但依然遵循 特性5)
---@desc 特性7、同一Rect，曾添加过2种以上天气后，则该视觉区在添加1次[迷雾类型|光束类型]后，则该视觉区的[其他][迷雾类型|光束类型]功能将被废且锁死，无法生效
