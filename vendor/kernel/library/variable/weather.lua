...
---@desc 特性2、迷雾类型指：薄雾/厚雾/风/大风；光束类型指：日光/月光
---@desc 特性3、同一片区域可以多次设置天气（但非常不建议，详情见特性6/7/8）
---@desc 特性4、同一片区域多次设置同一天气后，在视觉效果上不会有什么差异
---@desc 特性5、同源类型（如迷雾/光束），不能同时显示在同一片视觉区，会被抢先生成的占领视觉区，即使使用不同Rect也无效
---@desc 特性6、同一Rect，只添加最多1种天气时，此天气添加[迷雾类型]后，可后续修改为其他[迷雾类型](但依然遵循 特性5)
---@desc 特性7、同一Rect，曾添加过2种以上天气后，则该视觉区在添加1次[光束类型]后，则该视觉区的[其他][光束类型]功能将被废且锁死，无法生效
---@desc 特性8、同一Rect，曾添加过2种以上天气后，则该视觉区在添加1次[迷雾类型]后，则该视觉区的[其他][迷雾类型]功能将被废且锁死，无法生效
